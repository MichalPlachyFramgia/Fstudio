...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    ...
    <div class="x_content">
      ...
      @endif
      {!! Form::open(array('route' => 'gcm.store', 'class' => 'form-horizontal form-label-left')) !!}
        ...
        {!! Form::label('type', 'Type:', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) !!}
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="switch">
              {{ Form::radio('type', false, false , ['class' => 'switch-input', 'id' => 'direct']) }}
              <label for="direct" class="switch-label switch-label-off">Direct URL </label>
              {{ Form::radio('type', true, true, ['class' => 'switch-input', 'id' => 'market']) }}
        ...
        <div class="form-group">
          ...
          {!! Form::submit('Create New Message', ['class' => 'btn btn-success']) !!}
